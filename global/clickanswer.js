(async () => {
    ...
    n.remove();
            ...
            {
                answer = reactHandler().stateNode.state.question.correctAnswers.toString()
                arrayNumber = reactHandler().stateNode.state.question.answers.indexOf(answer)

                let arrayNumberUpdated = arrayNumber + 1
                document.getElementById("q" + arrayNumberUpdated).click()
